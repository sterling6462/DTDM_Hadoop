...
public class ShortestPathOutputKeyComparator extends WritableComparator
{
 
  public ShortestPathOutputKeyComparator()
  {
  ...
  public int compare(WritableComparable wc1, WritableComparable wc2)
  {
    ...
    try
    {
      weight1 = Integer.valueOf(nodeDetails1[ShortestPathMapper.INDEX_SOURCE_NODE_WEIGHT]);
    }
    catch (Exception e)
    {
    ...
    try
    {
      weight2 = Integer.valueOf(nodeDetails2[ShortestPathMapper.INDEX_SOURCE_NODE_WEIGHT]);
    }
    catch (Exception e)
    {
